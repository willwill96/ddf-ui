...
public class CatalogFrameworkImplTest {
    ...
    public void testGetResourceWhenNonNullResourceRequestExpectPostResourcePluginToReceiveResourceResponseWithNonNullResourceRequest()
        ...
        ResourceResponse resourceResponse = resourceFramework.getResource(mockResourceRequest,
                resourceSiteName);
    ...
    public void testPostQueryStopExecution() throws UnsupportedQueryException, FederationException {
        ...
        SourceResponseImpl sourceResponse = new SourceResponseImpl(request,
    ...
    public void testGetUnavailableFederatedSources() {
        ...
        for (SourceDescriptor descriptor : sourceDescriptors) {
            ...
            if (StringUtils.isNotBlank(descriptor.getId())) {
                ...
                assertTrue(descriptor.getContentTypes()
                        .isEmpty());
            }
        }
    ...
    public void testProviderUnavailableUpdateByID() throws SourceUnavailableException {
        ...
        try {
            ...
            UpdateRequest update = new UpdateRequestImpl((URI[]) uris.toArray(new URI[uris.size()]),
                    metacards);
    ...
    private CatalogFramework createDummyCatalogFramework(CatalogProvider provider,
            Map<String, CatalogStore> stores, Map<String, FederatedSource> sources,
            MockEventProcessor eventAdmin) {
    ...
    private CatalogFramework createDummyCatalogFramework(CatalogProvider provider,
            StorageProvider storageProvider, BundleContext context, MockEventProcessor admin,
